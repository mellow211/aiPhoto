  ...
  if (replicateToken && replicateToken !== 'YOUR_REPLICATE_API_TOKEN_HERE') {
    try {
      ...
      try {
        ...
        console.warn(`[VERCEL REPLICATE] gpt-4o failed or refused. Falling back to LLaVA. Error:`, gptError.message);
        ...
        console.log(`[VERCEL REPLICATE] Fallback LLaVA prediction created with ID: ${llavaPrediction.id}. Polling...`);
        ...
        console.log(`[VERCEL REPLICATE] Fallback LLaVA Face Analysis description: "${faceDescription}"`);
      }
